...
def create_philosophy_field(
    ...
    **kwargs,
    ...
    """Create a philosophy field with error handling"""
    try:
        # Create field without _field_category parameter
        field = PhilosophyField(
            name=name,
            description=description,
            category=category.to_philosophical_category(),
            priority=priority,
            required=required,
            data_type=data_type,
        ...
        # Set _field_category as an attribute after creation
        field._field_category = category

        return field
    except Exception as e:
        logger.error(f"Error creating philosophy field {name}: {e}")
        # Return a basic field as fallback
        fallback_field = PhilosophyField(
            name=name,
            description=description,
            category=None,
            priority=priority,
        ...
        fallback_field._field_category = category
